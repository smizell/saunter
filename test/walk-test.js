...
describe("walk", function () {
  ...
  context("when array items aren't walkable", function () {
    it("returns the actual value", function () {
      const subject = {
        a: [1, 2, 3],
      };
      const walker = walk(subject);
  ...
  context("when array items are walkable", function () {
    it("returns the nested value", function () {
      const subject = {
        a: [1, 2, 3],
      };
      const walker = walk(subject);
